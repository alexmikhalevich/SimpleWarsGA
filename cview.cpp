...
void CView::init() 
{
	...
	m_window = SDL_CreateWindow("SimpleGame", 0, 0, INIT_WINDOW_WIDTH, INIT_WINDOW_HEIGHT, SDL_WINDOW_SHOWN); //TODO
	if(m_window == NULL) 
		throw new ExWindowCreationFailed(std::string(SDL_GetError())); 
	m_renderer = SDL_CreateRenderer(m_window, -1, SDL_RENDERER_ACCELERATED | SDL_RENDERER_PRESENTVSYNC);
	m_field = new Field::CField(INIT_WINDOW_HEIGHT / Representation::CELL_SIZE, INIT_WINDOW_WIDTH / Representation::CELL_SIZE); //TODO 
