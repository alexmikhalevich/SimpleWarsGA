...
{ //TODO: change m_field logic
	int x = representation->x();
	int y = representation->y();
	if(representation->type() == Unit::EUnitClass::NO_UNIT) 
		m_field[x][y] = new Logic::CBullet();
	else 
		m_field[x][y] = new Logic::CUnit();	//TODO
...
{
	//TODO: fill m_field after changing m_field logic
